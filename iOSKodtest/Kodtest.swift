...
//  iOSKodtest
//
//  Created by Marcus Malmgren on 2023-11-29.
//
...
class Kodtest {
    ...
    /*
    kod1(mening: "Att programmera är skoj")
    kod1(mening: "När jag bygger exempelapplikationer så är koden fin")
    kod2(tal1: "sju", tal2: "tre", calctype: "plus")
    kod2(tal1: "två", tal2: "sju", calctype: "multiplikation")
    kod3(siffror: [2,5,4,6,9,2])
    kod3(siffror: [1,99,45,23,4,78,3])
    */
    ...
    func kod1(mening : String) {
        ...
        // Printa rad med stjränor som längsta ordet + 4
        var starrow = "*****"
        
        for i in 1...longestword.count + 5 {
            starrow = starrow + "*"
        }
    ...
    /*
           ...
           4 Dagny       5Erik    6Fredrika    7Göran
                \       /          \        /
                    2Berit           3Ceasar
                        \           /
                            1Arne
